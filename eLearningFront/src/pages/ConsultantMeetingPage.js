...
export default function ConsultantMeetingPage() {
...
jsonWebService
      .get(`${URL_WS}/meeting`)
      .then((response) => {
        let myMeetings = response.data.meetings.filter(m => m.consultant[0]?._id === userId)
                        ...
                        >
                          ...
                          <TableCell align="left">
                            <Iconify
                              ...
                              width={20}
                              height={20}
                              color={checkDate(date) === true ? "#85BB65" : "gray"}
                              style={{ cursor: 'pointer' }}
                              onClick= { e => checkDate(date) === true ? testPeerConn(_id, roomId) : alert("Please wait untill the meeting time")}
                            />
                          </TableCell>
                        </TableRow>
                      );
